package com.barackbao.electricmonitoring.widget;
...
public class FloatingActionButtonPlus extends ViewGroup {
    ...
    private void getAttributes(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = typedArray.getColor(R.styleable.FloatingActionButtonPlus_mBackgroundColor, Color.TRANSPARENT);
